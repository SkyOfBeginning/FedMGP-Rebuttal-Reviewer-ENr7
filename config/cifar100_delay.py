...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr', type=float, default=0.001875, metavar='LR', help='learning rate (default: 0.03)')
    ...
    # pool_size
    subparsers.add_argument('--size', default=1, type=int,)
    ...
    subparsers.add_argument('--client_num', default=5, type=int, nargs="+",
                            help='the num of client')
    subparsers.add_argument('--task_num', default=4, type=int, nargs="+",
                            help='the num of tasks')
    subparsers.add_argument('--private_class_num', default=15, type=int, nargs="+",
                            help='the num of client')
    ...
    subparsers.add_argument('--global_epoch', default=5, type=int, nargs="+",
                            help='the num of client')
    subparsers.add_argument('--local_epoch', default=5, type=int, nargs="+",
                            help='the num of client')
