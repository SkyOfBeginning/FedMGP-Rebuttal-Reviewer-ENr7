...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr', type=float, default=0.0015, metavar='LR', help='learning rate (default: 0.03)')
    ...
    subparsers.add_argument('--task_num', default=5, type=int, nargs="+",
